...
package it.estraspa.areaclienti;
    ...
    try {
      ...
      MobileCore.start(new AdobeCallback() {
        ...
        public void call(Object o) {
          MobileCore.configureWithAppID("70fb1bf779da/835ab0d1ad39/launch-bb2778caa0f2-development");
        }
      });
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("it.estraspa.areaclienti.ReactNativeFlipper");
        aClass
